...
?>
  ...
  <div id="popup-modal" tabindex="-1" class="bg-opacity-100 flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        <button id="close" onclick="closeModal()" type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
        ...
        <div class="p-4 md:p-5 text-center">
          ...
          <button id="okay" onclick="closeModal()" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Okay</button>
        </div>
      </div>
    </div>
  </div>
...
<div class="my-auto">
    <form class="mx-auto max-w-[calc(100vw-2rem)] w-96" action="/login" method="POST">
        @csrf
        <h1 class="text-center text-3xl font-bold m-5">Log in</h1>
      <div class="mb-5">
